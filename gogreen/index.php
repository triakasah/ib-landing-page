	...
	<body class="background-body">
		<div class="padding-form-register">
			<form class="form form-daftar" method="get" action="https://my.idnfbs.com/registration">
				...
				<div class="text_count_small mt_10 tc_gr1">
					Member baru bisa request $5.<br/> Tanpa perlu deposit.
				</div>
				<div class="inp">
				...
				<div class="t-bot"><a href="http://my.idnfbs.com">
					Saya sudah memiliki akun di FBS</a>
				</div>
			</form>
		</div>
