...
<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 tengah">
	<form class="form form-daftar tengah" method="get" action="https://my.idnfbs.com/registration">
			...
			<div class="t2 font-account">
				...
				<div class="text_count_small mt_10">Member baru bisa request $5.<br/> Tanpa perlu deposit.</div>
...
<div class="logo_place">
		...
		<div class="text_count mt_5"><b>Program kemitraan FBS baru yang revolusioner</b></div>
		<div class="text_lot ml_20">$15 per 1 lot untuk EUR/USD <sup class="fs_12"><br>dan lebih banyak!</sup></div>

		<div class="text_count_big mt_20 line-height">berlaku hingga akhir 2015</div>

</div>
</center>
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-9 col-lg-7 right-profit">
		<div class="calc calc1 tengah content_place1">
			<div class="head_calc">Hitung profit Anda</div>
			<div id="slider" class="slide-bar">
			...
			<div id="slider2" class="slide-bar">
			...
			<div class="text_count_big_l mt_41">Hasil bulanan Anda: <div class="summa" id="summa">200$</div></div>
		</div>	
...
<div class="content_place1">
	...
	<!-- <div class="text_count_middle2">
		<b class="salad">Penghargaan kami</b><br/>
		<a href="http://www.idnfbs.com/id/awards"><img src="http://landing.idnfbs.com/ru/partner-new/images/nagr.png" class="img-responsive" /></a>
	</div> -->
</div>
</div>
...
<div class="text_count_small mt_10 mb_40 tc_gr1"><a href="http://www.fbs.market/">www.fbs.com</a><br />
	<a href="http://www.fbs.com/sites/default/files/doc/fbs_privacy_policy.pdf" target="_blank">Privacy Policy</a></div>
