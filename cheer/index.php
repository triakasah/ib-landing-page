...
<html>
    ...
    <body>
        <div class="logo_place">
            ...
            <div class="content_place">
                <div class="calc">
                    ...
                    <div class="text_count_big_l">Email : <a href="mailto:farelnovi@yahoo.co.id" class="salad">farelnovi@yahoo.co.id </a></div>
                    <div class="text_count_big_l">No HP : <a href="callto:082219182912" class="salad">082219182912</a></div>
                ...
                <form class="form" method="get" action="https://my.idnfbs.com/registration">
                    ...
                    <div class="text_count_small">Member baru bisa request $5.<br/> Tanpa perlu deposit.</div>
                    <div class="inp">
        ...
        <div class="content_place">
            ...
            <p class="text_count mt_10"><b class="salad">Mari bergabung bersama kami guna meningkatkan investasi perdagangan anda dan meraih kesuksesan bersama kami <br> Dan saatnya Waktu yang paling tepat untuk membuka akun Forex, sesuai dengan kebutuhan Anda</b></p>
            <div class="text_count_middle">
                <blockquote class="fs_30">
                    <center><b class="salad">Keuntungan bergabung bersama kami :</b></center><br>
                    <center><p class="fs_20">
